       ...
       // --- Filter systems: Skills ---
        ...
        if (contactForm && formFeedback) {
            contactForm.addEventListener('submit', (e) => {
                ...
                window.location.href = `mailto:sudinneupane519@gmail.com?subject=${subject}&body=${body}`;

                formFeedback.className = "text-xs py-2 px-3 rounded-lg text-center font-mono bg-brand-green/10 text-brand-green border border-brand-green/30";
                formFeedback.textContent = "Launching mail agent... Thanks for connecting!";
                formFeedback.classList.remove('hidden');
